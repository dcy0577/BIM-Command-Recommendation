...
class Trainer(BaseTrainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs): # for new transformers version
        """
    ...
    def _use_cuda_amp(self):
        ...
        try:
            ...
            # since the new transformers version removed the use_cuda_amp property
            return False
